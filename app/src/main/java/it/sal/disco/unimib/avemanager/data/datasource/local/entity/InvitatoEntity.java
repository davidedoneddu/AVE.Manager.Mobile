...
public class InvitatoEntity {
    ...
    public InvitatoEntity(
            ...
            String invDirezione,
            Boolean invInvitato,
            Boolean invConfermato,
            Boolean invPresente,
            String invUserModifica,
            Boolean invNonPartecipa,
            String invNote,
            String invDtCheckin,
            String invEmail,
            String invWebCode,
            Boolean invWebInvitato,
            Boolean invWebRiscontro,
            String invWebDtinsRis,
            String invWebDtupdRis,
            String invEmailOriginale,
            Boolean invBadgeSpedito,
            Boolean invSaveTheDate,
            String invDtBadgeStampato,
            Integer invDtGiorniPassati,
            String invDtSaveTheDate,
            Boolean invNoAssegnaposto,
            Boolean invAccompagnatore,
            Boolean invBusta,
            String invCarica,
            String invDtCheckout,
            String invExPostoOccupato,
            Boolean invCena,
            String invSesso,
            String invRagSocBadge1,
            String invRagSocBadge2,
            Boolean invVotante,
            Boolean invPuoEssereSostituito,
            Boolean invPuoInvitare,
            Boolean invDownloadDoc,
            Integer invVotiSpettanti,
            Integer invSostituisceInvId,
            String invModelloEmail,
            Boolean invEmailBiglietto,
            String invBarcode,
            String invAssociazioneGestione,
            Boolean invCoptato,
            Boolean invAmministratoreSistema,
            Boolean invScrutinatore,
            Boolean invVediQuorum,
            Boolean invVediVotazioneRuntime,
            Boolean invVideocall,
            String invWebCodeOrig,
            Boolean invPuoFareSceltaA,
            Boolean invSceltaA,
            String invInfoSceltaA,
            Boolean invPuoFareSceltaB,
            Boolean invSceltaB,
            String invInfoSceltaB
    ) {
        this.invId = invId;
        this.invCodice = invCodice;
        this.invCognome = invCognome;
        this.invNome = invNome;
        this.invEveId = invEveId;
        this.invCortesia = invCortesia;
        this.invTitolo = invTitolo;
        this.invVotId = invVotId;
        this.invSocieta = invSocieta;
        this.invRagSoc = invRagSoc;
        this.invIndirizzo = invIndirizzo;
        this.invCap = invCap;
        this.invCitta = invCitta;
        this.invProvincia = invProvincia;
        this.invGrpCodice = invGrpCodice;
        this.invDirezione = invDirezione;
        this.invInvitato = invInvitato;
        this.invConfermato = invConfermato;
        this.invPresente = invPresente;
        this.invUserModifica = invUserModifica;
        this.invNonPartecipa = invNonPartecipa;
        this.invNote = invNote;
        this.invDtCheckin = invDtCheckin;
        this.invEmail = invEmail;
        this.invWebCode = invWebCode;
        this.invWebInvitato = invWebInvitato;
        this.invWebRiscontro = invWebRiscontro;
        this.invWebDtinsRis = invWebDtinsRis;
        this.invWebDtupdRis = invWebDtupdRis;
        this.invEmailOriginale = invEmailOriginale;
        this.invBadgeSpedito = invBadgeSpedito;
        this.invSaveTheDate = invSaveTheDate;
        this.invDtBadgeStampato = invDtBadgeStampato;
        this.invDtGiorniPassati = invDtGiorniPassati;
        this.invDtSaveTheDate = invDtSaveTheDate;
        this.invNoAssegnaposto = invNoAssegnaposto;
        this.invAccompagnatore = invAccompagnatore;
        this.invBusta = invBusta;
        this.invCarica = invCarica;
        this.invDtCheckout = invDtCheckout;
        this.invExPostoOccupato = invExPostoOccupato;
        this.invCena = invCena;
        this.invSesso = invSesso;
        this.invRagSocBadge1 = invRagSocBadge1;
        this.invRagSocBadge2 = invRagSocBadge2;
        this.invVotante = invVotante;
        this.invPuoEssereSostituito = invPuoEssereSostituito;
        this.invPuoInvitare = invPuoInvitare;
        this.invDownloadDoc = invDownloadDoc;
        this.invVotiSpettanti = invVotiSpettanti;
        this.invSostituisceInvId = invSostituisceInvId;
        this.invModelloEmail = invModelloEmail;
        this.invEmailBiglietto = invEmailBiglietto;
        this.invBarcode = invBarcode;
        this.invAssociazioneGestione = invAssociazioneGestione;
        this.invCoptato = invCoptato;
        this.invAmministratoreSistema = invAmministratoreSistema;
        this.invScrutinatore = invScrutinatore;
        this.invVediQuorum = invVediQuorum;
        this.invVediVotazioneRuntime = invVediVotazioneRuntime;
        this.invVideocall = invVideocall;
        this.invWebCodeOrig = invWebCodeOrig;
        this.invPuoFareSceltaA = invPuoFareSceltaA;
        this.invSceltaA = invSceltaA;
        this.invInfoSceltaA = invInfoSceltaA;
        this.invPuoFareSceltaB = invPuoFareSceltaB;
        this.invSceltaB = invSceltaB;
        this.invInfoSceltaB = invInfoSceltaB;
    }
